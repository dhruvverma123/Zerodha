  ...
  return (
    <div className="container pb-4">
      <div className="row p-5">
        <h1 style={{ fontSize: "24px", color: "#444", marginBottom: "50px" }}>
          Charges explained
        </h1>
        <div className="col-6">
          <h4
        ...
        <div className="col-6">
          ...
          <ul>
            ...
            >
              <b style={{ fontWeight: "500" }}> Delivery & MTF Brokerage:</b>{" "}
              0.5% per executed order.
            </li>
            <li
              style={{
                fontSize: "12px",
            ...
            >
              <b style={{ fontWeight: "500" }}> Intraday Brokerage:</b> 0.05%
              per executed order.
            </li>
          </ul>
        </div>
