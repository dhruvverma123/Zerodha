            ...
            <div>
              ...
              >
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-x-twitter hoverStyle"
                ...
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-square-facebook hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-instagram hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-linkedin-in hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
              ...
              >
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-youtube hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-whatsapp hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
                <li style={{ marginRight: "10px" }}>
                  <a href="">
                    <i
                      className="fa-brands fa-telegram hoverStyle"
                      style={{ color: "black", opacity: "0.6" }}
                    ></i>
                  </a>
                </li>
